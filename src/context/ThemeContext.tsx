...
const themes: Record<string, Theme> = {
  light: {
    ...
    cardBg: 'bg-white/95 backdrop-blur-xl border-2 border-slate-200 shadow-xl',
    border: 'border-slate-300',
    highlight: 'bg-slate-100/90 backdrop-blur-sm border-2 border-slate-200',
    shadow: 'shadow-xl hover:shadow-2xl',
    textMuted: 'text-slate-600',
    textCaption: 'text-slate-700',
    surface: 'bg-slate-100/80 backdrop-blur-sm border-2 border-slate-200',
  ...
  dark: {
    ...
    cardBg: 'bg-slate-800/95 backdrop-blur-xl border-2 border-slate-700 shadow-xl',
    border: 'border-slate-600',
    highlight: 'bg-slate-700/90 backdrop-blur-sm border-2 border-slate-600',
    shadow: 'shadow-xl hover:shadow-2xl',
    textMuted: 'text-slate-300',
    textCaption: 'text-slate-200',
    surface: 'bg-slate-700/80 backdrop-blur-sm border-2 border-slate-600',
  ...
  cyber: {
    ...
    cardBg: 'bg-black/95 backdrop-blur-xl border-2 border-green-500 shadow-xl shadow-green-500/30',
    border: 'border-green-500',
    highlight: 'bg-green-950/90 backdrop-blur-sm border-2 border-green-500',
    ...
    surface: 'bg-green-950/80 backdrop-blur-sm border-2 border-green-500/70',
    surfaceHover: 'hover:bg-green-900/80',
  ...
  gaming: {
    ...
    cardBg: 'bg-slate-900/95 backdrop-blur-xl border-2 border-purple-500 shadow-xl shadow-purple-500/30',
    border: 'border-purple-500',
    highlight: 'bg-purple-950/90 backdrop-blur-sm border-2 border-purple-500',
    ...
    surface: 'bg-purple-950/80 backdrop-blur-sm border-2 border-purple-500/70',
    surfaceHover: 'hover:bg-purple-900/80',
  ...
  neon: {
    ...
    cardBg: 'bg-black/95 backdrop-blur-xl border-2 border-pink-500 shadow-xl shadow-pink-500/30',
    border: 'border-pink-500',
    highlight: 'bg-pink-950/90 backdrop-blur-sm border-2 border-pink-500',
    ...
    surface: 'bg-pink-950/80 backdrop-blur-sm border-2 border-pink-500/70',
    surfaceHover: 'hover:bg-pink-900/80',
  ...
  ocean: {
    ...
    cardBg: 'bg-blue-900/95 backdrop-blur-xl border-2 border-cyan-500 shadow-xl shadow-cyan-500/30',
    border: 'border-cyan-500',
    highlight: 'bg-cyan-950/90 backdrop-blur-sm border-2 border-cyan-500',
    ...
    surface: 'bg-cyan-950/80 backdrop-blur-sm border-2 border-cyan-500/70',
    surfaceHover: 'hover:bg-cyan-900/80',
