  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      ...
      >
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2 font-orbitron">Create Account</h2>
          <p className="text-gray-400">Join the cybersecurity training platform</p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div>
            <label className="block text-gray-300 mb-2 font-rajdhani" htmlFor="confirmPassword">
              Confirm Password
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
