    ...
    <div className={`min-h-screen ${currentTheme.bgPrimary}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className={`text-2xl font-bold ${currentTheme.text}`}>Learning Modules</h1>
          ...
          {isAdmin && (
            <Link to="/editor">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`${currentTheme.buttonPrimary} px-4 py-2 rounded-lg flex items-center`}
              >
        ...
        <div className={`${currentTheme.bgSecondary} rounded-lg ${currentTheme.shadow} p-6 mb-8`}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <input
                ...
                className={`pl-10 pr-4 py-2 w-full rounded-lg border ${currentTheme.border} ${currentTheme.bgPrimary} ${currentTheme.text} focus:outline-none focus:ring-2 focus:ring-${currentTheme.accent}-500 transition-all duration-200`}
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className={`w-full rounded-lg px-3 py-2 border ${currentTheme.border} ${currentTheme.bgPrimary} ${currentTheme.text} focus:outline-none focus:ring-2 focus:ring-${currentTheme.accent}-500`}
              >
        ...
        {paginatedModules.length > 0 ? (
                  ...
                  >
                    <Link to={`/modules/${module.id}`}>
                      ...
                      <div className="p-6">
                        <div className="flex justify-between items-start mb-4">
                          <h2 className={`text-lg font-medium ${currentTheme.text}`}>{module.title}</h2>
                          {isCompleted ? (
                        ...
                        <p className={`${currentTheme.text} opacity-75 text-sm mb-4 line-clamp-2`}>
                          {module.description}
                        </p>
                        
                        <div className="flex items-center justify-between mb-4">
                          <span className={`text-sm px-3 py-1 ${currentTheme.highlight} rounded-full ${currentTheme.text}`}>
                            {module.category}
                          </span>
                    ...
                    {isAdmin && (
                      <motion.button
                        ...
                        className={`absolute top-4 right-4 p-2 rounded-full ${currentTheme.buttonSecondary} text-red-500 hover:bg-red-100 hover:text-red-600 transition-all duration-200 opacity-0 group-hover:opacity-100`}
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-4">
                <button
                  ...
                  className={`${currentTheme.buttonSecondary} p-2 rounded-full disabled:opacity-50`}
                >
          ...
          <div className={`${currentTheme.cardBg} rounded-lg ${currentTheme.shadow} p-8 text-center`}>
            ...
            <h3 className={`text-lg font-medium ${currentTheme.text} mb-2`}>No modules found</h3>
